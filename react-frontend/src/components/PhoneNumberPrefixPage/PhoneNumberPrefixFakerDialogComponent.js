...
const PhoneNumberPrefixFakerDialogComponent = (props) => {
    ...
    const onRun = async () => {
        ...
        setLoading(true);
        const promises = fakeData.map((elem) => client.service("phoneNumberPrefix").create(elem));
...
export default connect(mapState, mapDispatch)(PhoneNumberPrefixFakerDialogComponent);
