...
const FrequencyOfBillingFakerDialogComponent = (props) => {
    ...
    const onRun = async () => {
        ...
        setLoading(true);
        const promises = fakeData.map((elem) => client.service("frequencyOfBilling").create(elem));
...
export default connect(mapState, mapDispatch)(FrequencyOfBillingFakerDialogComponent);
